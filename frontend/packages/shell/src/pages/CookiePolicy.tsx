              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg border border-black/10">
                    ...
                    <div className="mt-4">
                      <p className="text-black/60 text-sm font-semibold mb-2">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-black/20">
                      <th className="text-left py-3 px-2 font-semibold text-black">
                  ...
                  <tbody>
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-2 text-black/70 font-mono text-xs">
                        {config.get('cookies.table.row1.name', 'session_id')}
                      </td>
                      <td className="py-3 px-2 text-black/70">
